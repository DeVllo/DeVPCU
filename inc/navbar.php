...
?>
<!-- Sidebar -->
<ul class="navbar-nav bg-gradient-<?php print($_SESSION['color_tema']); ?> sidebar sidebar-dark accordion" id="accordionSidebar">
...
<a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
  ...
  <div class="sidebar-brand-text mx-3">DevApp <sup>TM</sup></div>
</a>
...
<li class="nav-item">
  ...
  <div id="collapsePaint" class="collapse" aria-labelledby="headingPaint" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      ...
      <a class="collapse-item bg-primary" href="#"><i class="fas fa-fw fa-palette"></i> Azul oscuro</a>
      <a class="collapse-item bg-warning" onclick="cambiarColor(4)"href="#"><i class="fas fa-fw fa-palette"></i> Amarillo</a>
      <a class="collapse-item bg-danger" href="#"><i class="fas fa-fw fa-palette"></i> Rojo fuerte</a>
      <a class="collapse-item" href="cards.html">Restablecer</a>
    </div>
  </div>
</li>
<script>
